<?php 
    class Theater {
        ...
        public function selectTheater($id){
            $this->db->query('  SELECT movies.movie_id,movies.movie_name,hall.hall_name,movie_timings.movie_date_time                                 
                                ...
                                HAVING movies.movie_id = :id AND DATE(movie_timings.movie_date_time) >= "2020-02-14"
